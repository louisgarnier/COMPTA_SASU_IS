...
from backend.api.routes import financial as financial_routes
...
from backend.api.routes import monthly_balances as monthly_balances_routes
...
app.include_router(monthly_balances_routes.router)
